...
foodbeverage_instance(dietplanner, fat_oils, coconut_oil).
...
foodbeverage_instance(dietplanner, fat_oils, canola_oil).
...
foodbeverage_instance(dietplanner, fat_oils, sesame_oil).
...
foodbeverage_instance(dietplanner, fish_seafood, tuna).
...
foodbeverage_instance(dietplanner, fish_seafood, cod).
...
foodbeverage_instance(dietplanner, fish_seafood, crab).
...
foodbeverage_instance(dietplanner, fish_seafood, lobster).
...
foodbeverage_instance(dietplanner, meats, beef).
...
foodbeverage_instance(dietplanner, meats, pork).
...
foodbeverage_instance(dietplanner, meats, lamb).
...
foodbeverage_instance(dietplanner, meats, horse).
...
foodbeverage_instance(dietplanner, milk_cheese, whole_milk).
...
foodbeverage_instance(dietplanner, milk_cheese, soy_milk).
...
foodbeverage_instance(dietplanner, milk_cheese, almond_milk).
...
foodbeverage_instance(dietplanner, milk_cheese, coconut_milk).
...
foodbeverage_instance(dietplanner, milk_cheese, gorgonzola_cheese).
...
foodbeverage_instance(dietplanner, nuts, walnuts).
...
foodbeverage_instance(dietplanner, nuts, cashews).
...
foodbeverage_instance(dietplanner, nuts, pistachios).
...
foodbeverage_instance(dietplanner, nuts, pecans).
...
foodbeverage_instance(dietplanner, seeds, flaxseeds).
...
foodbeverage_instance(dietplanner, seeds, sunflower_seeds).
...
foodbeverage_instance(dietplanner, seeds, pumpkin_seeds).
...
foodbeverage_instance(dietplanner, seeds, sesame_seeds).
...
% Subclass: spices
foodbeverage_instance(dietplanner, spices, cinnamon).
...
foodbeverage_instance(dietplanner, spices, turmeric).
...
foodbeverage_instance(dietplanner, spices, paprika).
...
foodbeverage_instance(dietplanner, spices, cumin).
...
foodbeverage_instance(dietplanner, spices, black_pepper).
...
attribute_value(dietplanner, cookies, calories, 353).
...
foodbeverage_instance(dietplanner, vegetables, button_mushroom).
...
foodbeverage_instance(dietplanner, vegetables, porcini_mushroom).
...
% Subclass: juice
foodbeverage_instance(dietplanner, juice, orange_juice).
...
foodbeverage_instance(dietplanner, juice, grapefruit_juice).
...
foodbeverage_instance(dietplanner, juice, pineapple_juice).
...
foodbeverage_instance(dietplanner, juice, cranberry_juice).
...
foodbeverage_instance(dietplanner, juice, mango_juice).
...
foodbeverage_instance(dietplanner, juice, watermelon_juice).
...
% Subclass: water
foodbeverage_instance(dietplanner, water, mineral_water).
...
foodbeverage_instance(dietplanner, water, sparkling_water).
...
attribute_value(dietplanner, lactose, name, 'Lactose').
attribute_value(dietplanner, lactose, description, 'A sugar commonly found in milk and dairy products.').

allergen_instance(dietplanner, allergen, cocoa).
attribute_value(dietplanner, cocoa, name, 'Cocoa').
attribute_value(dietplanner, cocoa, description, 'An allergen derived from the cocoa bean, commonly used to make chocolate and cocoa-based products.').
...
has_nutrient(granola, dairy_protein, 8.0).
...
has_nutrient(ham, lean_protein, 20.0).
...
has_nutrient(quinoa, plant_protein, 14.0).
...
has_nutrient(oats, plant_protein, 16.9).

has_nutrient(nuts, plant_protein, 21.2).
...
made_of(scrambled_eggs_and_toast, white_bread, 20, 80).
...
made_of(turkey_and_avocado_wrap, avocado, 40, 100).
...
made_of(vegetarian_pasta_primavera, bell_pepper, 50, 100).
...
made_of(grilled_vegetable_platter, bell_pepper, 60, 150).
...
made_of(tofu_and_broccoli_stir_fry, bell_pepper, 50, 100).
...
made_of(veggie_spring_rolls, bell_pepper, 30, 60).
...
made_of(vegetable_sticks_with_hummus, bell_pepper, 50, 100).
...
made_of(chicken_stir_fry, bell_pepper, 50, 100).
...
made_of(pasta_primavera, bell_pepper, 20, 50).
...
made_of(veggie_pizza, bell_pepper, 30, 50).
...
made_of(garden_salad, bell_pepper, 20, 40).
...
made_of(sushi_roll, avocado, 10, 50).

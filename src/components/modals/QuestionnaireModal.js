...
/**Dynamic modal for inferring the best diet types for the patient.
 It shows the question generated by prolog, when the user selects the answer, it is given to prolog to generate the next question.
 If the user changes a previously answered answer, subsequent questions are removed and the new question is regenerated by prolog.
 The iteration continues until prolog answers "no" and then the questions are over.
 At this point the modal shows a select to choose the type of inferential strategy with which to process the answers.
 The user views the diet types generated and can choose to see why they were generated, edit the diet types generated and save new data.**/
